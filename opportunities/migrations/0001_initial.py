    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.CharField(help_text='Brief description for listings', max_length=500)),
                ('description', models.TextField(help_text='Full description with requirements and benefits')),
                ('opportunity_type', models.CharField(choices=[('job', 'Job'), ('scholarship', 'Scholarship'), ('grant', 'Grant'), ('internship', 'Internship'), ('fellowship', 'Fellowship'), ('volunteer', 'Volunteer'), ('business', 'Business Opportunity'), ('funding', 'Funding'), ('mentorship', 'Mentorship'), ('training', 'Training/Workshop')], max_length=20)),
                ('organization_name', models.CharField(max_length=200)),
                ('organization_logo', models.ImageField(blank=True, upload_to='opportunities/logos/')),
                ...
                ('employment_type', models.CharField(blank=True, choices=[('full-time', 'Full-time'), ('part-time', 'Part-time'), ('contract', 'Contract'), ('freelance', 'Freelance'), ('remote', 'Remote'), ('hybrid', 'Hybrid'), ('temporary', 'Temporary')], max_length=20)),
                ('experience_level', models.CharField(blank=True, choices=[('entry', 'Entry Level'), ('mid', 'Mid Level'), ('senior', 'Senior Level'), ('executive', 'Executive'), ('internship', 'Internship'), ('no-experience', 'No Experience Required')], max_length=20)),
                ...
                ('funding_currency', models.CharField(blank=True, default='GHS', max_length=3)),
                ('duration', models.CharField(blank=True, help_text='Duration of opportunity', max_length=100)),
                ('eligibility_criteria', models.TextField(blank=True)),
                ('selection_process', models.TextField(blank=True)),
                ('number_of_slots', models.PositiveIntegerField(default=1)),
                ('application_method', models.CharField(default='external', max_length=50)),
                ...
                ('featured_image', models.ImageField(blank=True, upload_to='opportunities/featured/%Y/%m/')),
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('pending_review', 'Pending Review'), ('published', 'Published'), ('expired', 'Expired'), ('filled', 'Filled'), ('cancelled', 'Cancelled')], default='draft', max_length=20)),
                ...
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='opportunities', to='tags.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(max_length=200)),
                ('cv_file', models.FileField(blank=True, upload_to='applications/cvs/%Y/%m/')),
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('submitted', 'Submitted'), ('under_review', 'Under Review'), ('shortlisted', 'Shortlisted'), ('interview_scheduled', 'Interview Scheduled'), ('accepted', 'Accepted'), ('rejected', 'Rejected'), ('withdrawn', 'Withdrawn')], default='draft', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequency', models.CharField(choices=[('instant', 'Instant'), ('daily', 'Daily'), ('weekly', 'Weekly'), ('monthly', 'Monthly')], default='weekly', max_length=20)),
                ('last_sent', models.DateTimeField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='opportunity_alerts', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('opportunity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gallery_images', to='opportunities.opportunity')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='opportunity',
            index=models.Index(fields=['is_featured', 'is_trending'], name='opportuniti_is_feat_222fb9_idx'),
        ),
        migrations.AddIndex(
            model_name='application',
            index=models.Index(fields=['opportunity', 'status'], name='opportuniti_opportu_3d9fba_idx'),
        ),
        migrations.AddIndex(
            model_name='application',
            index=models.Index(fields=['applicant'], name='opportuniti_applica_bec37d_idx'),
        ),
