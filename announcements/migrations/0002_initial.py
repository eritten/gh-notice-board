    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="announcemen_announc_eccb99_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="announcement",
            index=models.Index(
                fields=["is_emergency", "is_pinned"],
                name="announcemen_is_emer_e7186d_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="announcement",
        ...
        migrations.AddIndex(
            model_name="announcement",
            index=models.Index(
                fields=["expires_at"], name="announcemen_expires_854584_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="announcement",
            index=models.Index(
                fields=["target_audience"], name="announcemen_target__f9678f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="announcementacknowledgment",
            index=models.Index(
                fields=["announcement", "user"], name="announcemen_announc_d93e23_idx"
            ),
        ),
