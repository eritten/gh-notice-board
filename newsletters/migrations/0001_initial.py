    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('newsletter_type', models.CharField(choices=[('regular', 'Regular Newsletter'), ('special', 'Special Announcement'), ('digest', 'Weekly/Monthly Digest'), ('breaking', 'Breaking News'), ('promotional', 'Promotional'), ('event', 'Event Invitation')], default='regular', max_length=20)),
                ('subject', models.CharField(help_text='Email subject line', max_length=200)),
                ('preheader', models.CharField(blank=True, help_text='Preview text', max_length=200)),
                ...
                ('featured_news', models.JSONField(blank=True, default=list, help_text='List of news IDs')),
                ('featured_events', models.JSONField(blank=True, default=list, help_text='List of event IDs')),
                ('featured_opportunities', models.JSONField(blank=True, default=list, help_text='List of opportunity IDs')),
                ('featured_announcements', models.JSONField(blank=True, default=list, help_text='List of announcement IDs')),
                ('send_to_all', models.BooleanField(default=False)),
                ('target_segments', models.JSONField(blank=True, default=dict, help_text='Segment targeting criteria')),
                ...
                ('test_emails', models.JSONField(blank=True, default=list, help_text='List of test email addresses')),
                ('use_personalization', models.BooleanField(default=True)),
                ('from_name', models.CharField(default='Ghana Notice Board', max_length=100)),
                ('from_email', models.EmailField(default='newsletter@ghanaticeboard.com', max_length=254)),
                ...
                ('approved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='approved_newsletters', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequency', models.CharField(choices=[('instant', 'Instant'), ('daily', 'Daily Digest'), ('weekly', 'Weekly Digest'), ('monthly', 'Monthly Roundup')], default='weekly', max_length=10)),
                ('preferred_language', models.CharField(default='en', help_text='Preferred language code', max_length=10)),
                ('preferred_categories', models.JSONField(blank=True, default=list, help_text='List of category IDs')),
                ...
                ('referrer', models.CharField(blank=True, help_text='How they subscribed', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('sent', 'Sent'), ('delivered', 'Delivered'), ('opened', 'Opened'), ('clicked', 'Clicked'), ('bounced', 'Bounced'), ('complained', 'Complained'), ('unsubscribed', 'Unsubscribed')], default='pending', max_length=20)),
                ('email_id', models.CharField(blank=True, help_text='Email service provider ID', max_length=200)),
                ('sent_at', models.DateTimeField(blank=True, null=True)),
                ...
                ('subscriber', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='emails', to='newsletters.newslettersubscriber')),
            ],
            options={
                'ordering': ['-sent_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_type', models.CharField(choices=[('regular', 'Regular Newsletter'), ('digest', 'Digest'), ('event', 'Event Announcement'), ('special', 'Special Announcement'), ('promotional', 'Promotional')], default='regular', max_length=20)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['status', 'scheduled_for'], name='newsletters_status_47c5bc_idx'),
        ),
        migrations.AddIndex(
            model_name='newsletter',
        ...
        migrations.AddIndex(
            model_name='newsletter',
            index=models.Index(fields=['-created_at'], name='newsletters_created_1a7d70_idx'),
        ),
        migrations.AddIndex(
            model_name='newslettersubscriber',
            index=models.Index(fields=['status', 'frequency'], name='newsletters_status_8def46_idx'),
        ),
        migrations.AddIndex(
            model_name='newslettersubscriber',
        ...
        migrations.AddIndex(
            model_name='newslettersubscriber',
            index=models.Index(fields=['confirmation_token'], name='newsletters_confirm_78f16b_idx'),
        ),
        migrations.AddIndex(
            model_name='newsletteremail',
            index=models.Index(fields=['newsletter', 'status'], name='newsletters_newslet_d35335_idx'),
        ),
        migrations.AddIndex(
            model_name='newsletteremail',
            index=models.Index(fields=['subscriber'], name='newsletters_subscri_7aaada_idx'),
        ),
