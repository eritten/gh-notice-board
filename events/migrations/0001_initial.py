    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.CharField(choices=[('in-person', 'In Person'), ('virtual', 'Virtual'), ('hybrid', 'Hybrid')], default='in-person', max_length=20)),
                ...
                ('featured_image', models.ImageField(blank=True, upload_to='events/featured/%Y/%m/')),
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('pending_review', 'Pending Review'), ('published', 'Published'), ('cancelled', 'Cancelled'), ('postponed', 'Postponed'), ('completed', 'Completed')], default='draft', max_length=20)),
                ...
                ('check_in_code', models.CharField(blank=True, help_text='QR code for check-in', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('registration_type', models.CharField(choices=[('regular', 'Regular'), ('early_bird', 'Early Bird'), ('vip', 'VIP'), ('student', 'Student'), ('group', 'Group'), ('complimentary', 'Complimentary')], default='regular', max_length=20)),
                ('ticket_number', models.CharField(max_length=50, unique=True)),
                ('amount_paid', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('payment_reference', models.CharField(blank=True, max_length=100)),
                ('payment_date', models.DateTimeField(blank=True, null=True)),
                ('status', models.CharField(choices=[('pending', 'Pending Payment'), ('confirmed', 'Confirmed'), ('waitlisted', 'Waitlisted'), ('cancelled', 'Cancelled'), ('refunded', 'Refunded')], default='pending', max_length=20)),
                ('attendance_status', models.CharField(choices=[('not_checked_in', 'Not Checked In'), ('checked_in', 'Checked In'), ('no_show', 'No Show')], default='not_checked_in', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('website', models.URLField(blank=True)),
                ('description', models.TextField(blank=True)),
                ('sponsorship_level', models.CharField(choices=[('title', 'Title Sponsor'), ('platinum', 'Platinum'), ('gold', 'Gold'), ('silver', 'Silver'), ('bronze', 'Bronze'), ('partner', 'Partner')], default='partner', max_length=20)),
                ('order', models.PositiveIntegerField(default=0)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.AddIndex(
            model_name='event',
            index=models.Index(fields=['is_featured', 'is_trending'], name='events_even_is_feat_b1c4fd_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='eventregistration',
            index=models.Index(fields=['ticket_number'], name='events_even_ticket__605189_idx'),
        ),
