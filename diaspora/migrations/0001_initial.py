    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_diaspora_author",
                    models.BooleanField(
                        default=True, help_text="Is the author from diaspora"
                    ),
                ),
                (
                    "region",
                ...
                (
                    "country",
                    models.CharField(help_text="Specific country", max_length=100),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Name of diaspora community",
                        max_length=200,
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Embassy, Association, Business, etc.",
                        max_length=100,
                    ),
                ),
                (
                    "organization_logo",
                    models.ImageField(blank=True, upload_to="diaspora/logos/"),
                ),
                ("organization_verified", models.BooleanField(default=False)),
                (
                    "featured_image",
                    models.ImageField(blank=True, upload_to="diaspora/featured/%Y/%m/"),
                ),
                (
                    "featured_video_url",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Requires diaspora membership to view full content",
                    ),
                ),
                (
                    "status",
                ...
                (
                    "is_urgent",
                    models.BooleanField(default=False, help_text="Urgent notice"),
                ),
                (
                    "is_pinned",
                    models.BooleanField(default=False, help_text="Pin to top"),
                ),
                (
                    "investment_amount",
                    models.DecimalField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "origin_region",
                    models.CharField(help_text="Region in Ghana", max_length=100),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="e.g., 'Available for consultancy'",
                        max_length=100,
                    ),
                ),
                (
                    "profile_photo",
                    models.ImageField(
                        blank=True, upload_to="diaspora/directory/profiles/"
                    ),
                ),
                (
                    "business_logo",
                    models.ImageField(
                        blank=True, upload_to="diaspora/directory/logos/"
                    ),
                ),
                ("is_verified", models.BooleanField(default=False)),
                (
                    "verification_documents",
                    models.FileField(blank=True, upload_to="diaspora/directory/docs/"),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["listing_type", "profession"],
                        name="diaspora_di_listing_eff7bb_idx",
                    ),
                    models.Index(
                        fields=["current_country", "current_city"],
                        name="diaspora_di_current_9b2319_idx",
                    ),
                    models.Index(
                        fields=["is_verified", "is_active"],
                        name="diaspora_di_is_veri_9f590f_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "business_plan",
                    models.FileField(
                        blank=True, upload_to="diaspora/investments/plans/"
                    ),
                ),
                (
                    "financial_projections",
                    models.FileField(
                        blank=True, upload_to="diaspora/investments/financials/"
                    ),
                ),
                (
                    "pitch_deck",
                    models.FileField(
                        blank=True, upload_to="diaspora/investments/pitches/"
                    ),
                ),
                (
                    "featured_image",
                    models.ImageField(
                        blank=True, upload_to="diaspora/investments/images/"
                    ),
                ),
                ("is_verified", models.BooleanField(default=False)),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["investment_type", "investment_stage"],
                        name="diaspora_di_investm_17c338_idx",
                    ),
                    models.Index(fields=["slug"], name="diaspora_di_slug_d1597d_idx"),
                    models.Index(
                        fields=["is_verified", "is_active"],
                        name="diaspora_di_is_veri_de6d29_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "chapters",
                    models.JSONField(
                        blank=True, default=list, help_text="List of chapter locations"
                    ),
                ),
                ...
                (
                    "logo",
                    models.ImageField(blank=True, upload_to="diaspora/networks/logos/"),
                ),
                (
                    "cover_image",
                    models.ImageField(
                        blank=True, upload_to="diaspora/networks/covers/"
                    ),
                ),
                ("is_verified", models.BooleanField(default=False)),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["network_type", "based_in_country"],
                        name="diaspora_di_network_3102dd_idx",
                    ),
                    models.Index(fields=["slug"], name="diaspora_di_slug_698f2e_idx"),
                    models.Index(
                        fields=["is_verified", "is_active"],
                        name="diaspora_di_is_veri_f411ea_idx",
                    ),
                ],
            },
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["content_type", "status"], name="diaspora_di_content_477990_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="diasporapost",
            index=models.Index(
                fields=["region", "country"], name="diaspora_di_region_6ed009_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="diasporapost",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="diaspora_di_is_feat_afa0a1_idx",
            ),
        ),
    ]
